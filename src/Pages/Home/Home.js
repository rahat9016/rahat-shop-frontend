            ...
            products?.products?.map((product, index) => {
              return (
                ...
                >
                  ...
                  <div className={`${"information"+ index} flex items-center justify-between mt-2`}>
                <div className="flex bg-[#E4EFE9] rounded-md justify-between items-center">
                  <button
                    className="px-2 py-3"
                    onClick={handleDecrement}
                  >
                    <AiOutlineMinus fontFamily="font-fira" color="#C7C7C7"/>
                  </button>
                  <span className="px-2 py-3 font-bold">
                  {quantity}
                  </span>
                  <button
                    className="px-2 py-3"
                  ...
                  >
                    <AiOutlinePlus fontFamily="font-fira "color="#6BAF87"/>
                  </button>
                </div>
                    <div className="flex items-center gap-2">
                      <p className="flex items-center font-bold"><BsCurrencyDollar/>{product.price}</p>
                      <div className="">
                        <span className="w-12 h-12 rounded-xl flex items-center justify-center bg-[#E4EFE9]"><AiOutlineShoppingCart size={`30px` }  color="#6BAF87" className="cursor-pointer" onClick={()=> handleCart(product._id)}/></span>
                      </div>
                    </div>
